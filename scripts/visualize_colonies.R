...
####---- LET'S DO A MAP WITH AK, OR, BC, and WA ----####
...
ggmap(myMap) +
  ...
  ggtitle("Puffin Data Sources in AK, BC, WA, and OR")
ggsave("data/a_figures/AK_and_BC_and_WA_and_OR.jpg")
...
OR_area <- c(left = -126.5, bottom = 41.5, right = -122, top = 47)
plot(OR_area)
#get stamen map for bounding box
...
colors <- c('#e41a1c','#000000','#984ea3','#ff7f00','#ffff33')
ggmap(myMap) +
...
ggsave("data/a_figures/LastYr_AK_and_BC_and_WA_and_OR.jpg")
