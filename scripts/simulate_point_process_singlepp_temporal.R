#---
#"Simulating Point Process for Island Resembling Aiktak with Additional Temporal Component"
#"Lisanne Petracca"
#"Nov 2022"
#---

#This is script summarizing the creation of a clustered point process on an island of similar size to Aiktak
#It differs from the code ending with _aiktak in the sense that a very basic temporal component was added
#The other code assumed a single time period
